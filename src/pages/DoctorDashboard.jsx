                      ...
                      >
                        <div className="flex items-start justify-between">
                          <div className="flex-1">
                            ...
                            <p className="text-gray-600 mt-1">{report.reference_code}</p>
                    ...
                    <div className="p-6 border-b">
                      <div className="flex items-start justify-between">
                        <div>
                          ...
                          <p className="text-gray-600 mt-1">{selectedReport.reference_code}</p>
                        </div>
                      ...
                      <div>
                        ...
                        <div className="space-y-3 mb-4">
                          {selectedReport.notes && selectedReport.notes.length > 0 ? (
                            ...
                            <p className="text-gray-500 text-sm">No clinical notes added yet</p>
                          )}
                        </div>
                        <div className="flex space-x-2">
                          <input
                            ...
                            onKeyPress={(e) => e.key === 'Enter' && addNote(selectedReport.id)}
                          />
                          <button
                      ...
                      <div>
                        ...
                        <div className="grid grid-cols-2 gap-4 mb-4">
                          {selectedReport.images && selectedReport.images.length > 0 ? (
                            ...
                            <p className="col-span-2 text-gray-500 text-sm">No images uploaded yet</p>
                          )}
                        </div>
                        <label className="flex items-center justify-center space-x-2 px-4 py-2 border-2 border-dashed border-gray-300 rounded-lg cursor-pointer hover:border-blue-500 hover:bg-blue-50 transition-colors">
                          ...
                          <input
                            type="file"
                            accept="image/*"
                            onChange={(e) => handleImageUpload(selectedReport.id, e)}
                            className="hidden"
                          />
                        </label>
                      </div>
